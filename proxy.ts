/**
 * Next.js Proxy Middleware for Subdomain Routing
 * 
 ...
 * 
 * Note: This was renamed from middleware.ts to proxy.ts to follow Next.js
 * App Router best practices and avoid deprecation warnings.
 * 
